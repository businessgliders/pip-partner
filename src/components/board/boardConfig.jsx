...
export const STATUS_META = {
  ...
  instructor: {
    ...
    hired: { label: "Hired", description: "Offer accepted — joined the team" },
    onboarding: { label: "Onboarding", description: "Training and studio onboarding in progress" },
  },
  frontadmin: {
    shortlisted: { label: "Shortlisted", description: "Selected for the next step — contract stage" },
    declined: { label: "Not Interested", description: "Lead opted out or was disqualified" },
...
export const BOARD_TYPES = [
  {
    ...
    tabKey: "franchise",
    statuses: ["new", "discovery", "no_show", "nda", "fdd", "ghosted", "closed", "signed", "site_selection", "lease", "build_out", "training"],
    stepOne: ["new", "discovery", "no_show", "nda", "fdd", "ghosted", "closed"],
    stepTwo: ["signed", "site_selection", "lease", "build_out", "training"],
    stepTitles: { 1: "Pipeline — inquiry through FDD", 2: "Onboarding — signed through training" },
  ...
  },
  {
    ...
    tabKey: "instructor",
    statuses: ["pending", "reviewed", "shortlisted", "ghosted", "invited", "declined", "hired", "onboarding"],
    stepOne: ["pending", "reviewed", "shortlisted", "ghosted", "invited", "declined"],
    stepTwo: ["hired", "onboarding"],
    stepTitles: { 1: "Pipeline — pending through invited", 2: "Post-hire — hired and onboarding" },
    categoryField: "province",
    color: "#c4896b",
    bg: "#f6eee7",
  },
