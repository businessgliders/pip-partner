      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        >
          <div className="flex items-center gap-3 min-w-0">
            ...
            {page === "leads" ? (
              <h1 className="flex items-center gap-2 text-xl lg:text-2xl font-semibold truncate" style={{ color: CRM.ink }}>
                <Users className="w-5 h-5 lg:w-6 lg:h-6 shrink-0" style={{ color: CRM.accent }} />
