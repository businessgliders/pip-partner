...
export default function InfluencerProgram() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "linear-gradient(180deg, #f889b 0%, #f7b1bd 30%, #fbe0e2 60%, #f6eee7 100%)" }}>
      {/* Hero Section */}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="border-[#f7b1bd]/50 focus:border-[#f889b] focus:ring-[#f889b]/20 rounded-xl h-12 bg-white/50"
                    />
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger className="border-[#f7b1bd]/50 focus:border-[#f889b] focus:ring-[#f889b]/20 rounded-xl h-12 bg-white/50">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="border-[#f7b1bd]/50 focus:border-[#f889b] focus:ring-[#f889b]/20 rounded-xl min-h-[120px] bg-white/50 resize-none"
                  />
                </div>
